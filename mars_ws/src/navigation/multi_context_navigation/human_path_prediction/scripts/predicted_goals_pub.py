...
class PredictGoal(object):
    def __init__(self, human_num=1):
        ...
        self.goals_y = []
        self.resolution = 0.5  
        self.json_file = "/home/developer/lab/socially-store-robot/mars_ws/src/navigation/multi_context_navigation/human_path_prediction/scripts/crossing_corrider_outlines.json"
