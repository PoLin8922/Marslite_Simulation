...
def main():
    ...
    # ## -4.6,-0.4    -2.2,-0.4      -3,1.55
    # static_human ='-4.70,-2.60;-2.70,-2.60;1.40,-2.60;3.40,-2.60;-4.6,-0.4;-2.2,-0.4;1.42,-0.4;3.7,-0.4;-3,1.55;-1,1.55;0.25,1.55;2.2,1.55'
    # # static_human ='-4.70,-2.60;-2.70,-2.60;1.40,-2.60;3.40,-2.60;-4.6,-0.2;-2.2,-0.2;1.42,-0.2;3.7,-0.2;-3,1.45;-1,1.45;0.25,1.55;2.2,1.55'
    ...
    # robot_end_y = -34.0
    # robot_end_rot = 4.71
    # static_human ='-1.892,-5.294;1.0,-9.1'
    # scene_file = 'Simulation3'
    # scene = 'simulation3_v2'
